...
constexpr StatusBar::AreaData STYLESHEET_480_480_DARK_STATUS_BAR_AREA_DATA(int w_percent, StatusBar::AreaAlign align)
{
    return {
...
constexpr StatusBar::Data STYLESHEET_480_480_DARK_STATUS_BAR_DATA = {
    .main = {
    ...
    .area = {
        .num = 2,
        .data = {
            STYLESHEET_480_480_DARK_STATUS_BAR_AREA_DATA(50, StatusBar::AreaAlign::START),
            STYLESHEET_480_480_DARK_STATUS_BAR_AREA_DATA(50, StatusBar::AreaAlign::END),
        },
    },
