...
constexpr AppLauncherIcon::Data STYLESHEET_800_1280_DARK_APP_LAUNCHER_ICON_DATA = {
    .main = {
...
constexpr AppLauncherData STYLESHEET_800_1280_DARK_APP_LAUNCHER_DATA = {
    .main = {
        .y_start = 0,
    ...
    .table = {
        .default_num = 3,
        .size = gui::StyleSize::RECT_W_PERCENT(100, 1150),
    },
    .indicator = {
    ...
    .icon = STYLESHEET_800_1280_DARK_APP_LAUNCHER_ICON_DATA,
    .flags = {
