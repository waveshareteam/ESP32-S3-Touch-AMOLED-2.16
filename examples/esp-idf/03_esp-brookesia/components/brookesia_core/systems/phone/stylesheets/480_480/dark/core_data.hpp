...
constexpr base::Display::Data STYLESHEET_480_480_DARK_CORE_DISPLAY_DATA = {
    .background = {
...
constexpr base::Manager::Data STYLESHEET_480_480_DARK_CORE_MANAGER_DATA = {
    .app = {
        .max_running_num = 3,
    },
    .flags = {
...
constexpr const char *STYLESHEET_480_480_DARK_CORE_INFO_DATA_NAME = "480x480 Dark";

constexpr base::Context::Data STYLESHEET_480_480_DARK_CORE_DATA = {
    .name = STYLESHEET_480_480_DARK_CORE_INFO_DATA_NAME,
    .screen_size = gui::StyleSize::RECT(480, 480),
    .display = STYLESHEET_480_480_DARK_CORE_DISPLAY_DATA,
    .manager = STYLESHEET_480_480_DARK_CORE_MANAGER_DATA,
};
