...
constexpr base::Display::Data STYLESHEET_800_480_DARK_CORE_DISPLAY_DATA = {
    .background = {
...
constexpr base::Manager::Data STYLESHEET_800_480_DARK_CORE_MANAGER_DATA = {
    .app = {
        .max_running_num = 3,
    },
    .flags = {
...
constexpr const char *STYLESHEET_800_480_DARK_CORE_INFO_DATA_NAME = "800x480 Dark";

constexpr base::Context::Data STYLESHEET_800_480_DARK_CORE_DATA = {
    .name = STYLESHEET_800_480_DARK_CORE_INFO_DATA_NAME,
    .screen_size = gui::StyleSize::RECT(800, 480),
    .display = STYLESHEET_800_480_DARK_CORE_DISPLAY_DATA,
    .manager = STYLESHEET_800_480_DARK_CORE_MANAGER_DATA,
};
