...
constexpr RecentsScreenSnapshot::Data STYLESHEET_1024_600_DARK_RECENTS_SCREEN_SNAPSHOT_DATA = {
    .main_size = gui::StyleSize::RECT(614, 420),
    .title = {
        .main_size = gui::StyleSize::RECT(614, 60),
    ...
    .image = {
        .main_size = gui::StyleSize::RECT(614, 360),
        .radius = 22,
    },
};

constexpr RecentsScreen::Data STYLESHEET_1024_600_DARK_RECENTS_SCREEN_DATA = {
    .main = {
    ...
    .memory = {
        ...
        .label_text_font = gui::StyleFont::SIZE(20),
    ...
    .snapshot_table = {
        ...
        .snapshot = STYLESHEET_1024_600_DARK_RECENTS_SCREEN_SNAPSHOT_DATA,
    },
    .trash_icon = {
