...
constexpr RecentsScreenSnapshot::Data STYLESHEET_720_1280_DARK_RECENTS_SCREEN_SNAPSHOT_DATA = {
    .main_size = gui::StyleSize::RECT(450, 880),
    .title = {
        .main_size = gui::StyleSize::RECT(450, 80),
        .main_layout_column_pad = 10,
        .icon_size = gui::StyleSize::SQUARE(48),
        .text_font = gui::StyleFont::SIZE(28),
        .text_color = gui::StyleColor::COLOR(0xFFFFFF),
    },
    .image = {
        .main_size = gui::StyleSize::RECT(450, 800),
        .radius = 22,
    },
};

constexpr RecentsScreen::Data STYLESHEET_720_1280_DARK_RECENTS_SCREEN_DATA = {
    .main = {
    ...
    .memory = {
        .main_size = gui::StyleSize::RECT_W_PERCENT(100, 28),
    ...
    .snapshot_table = {
        ...
        .snapshot = STYLESHEET_720_1280_DARK_RECENTS_SCREEN_SNAPSHOT_DATA,
    },
    .trash_icon = {
        .default_size = gui::StyleSize::SQUARE(64),
        .press_size = gui::StyleSize::SQUARE(58),
