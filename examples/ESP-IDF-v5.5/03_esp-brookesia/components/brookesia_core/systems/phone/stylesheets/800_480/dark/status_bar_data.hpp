...
constexpr StatusBar::AreaData STYLESHEET_800_480_DARK_STATUS_BAR_AREA_DATA(int w_percent, StatusBar::AreaAlign align)
{
    return {
...
constexpr StatusBar::Data STYLESHEET_800_480_DARK_STATUS_BAR_DATA = {
    .main = {
    ...
    .area = {
        ...
        .data = {
            STYLESHEET_800_480_DARK_STATUS_BAR_AREA_DATA(33, StatusBar::AreaAlign::START),
            STYLESHEET_800_480_DARK_STATUS_BAR_AREA_DATA(34, StatusBar::AreaAlign::CENTER),
            STYLESHEET_800_480_DARK_STATUS_BAR_AREA_DATA(33, StatusBar::AreaAlign::END),
        },
    },
