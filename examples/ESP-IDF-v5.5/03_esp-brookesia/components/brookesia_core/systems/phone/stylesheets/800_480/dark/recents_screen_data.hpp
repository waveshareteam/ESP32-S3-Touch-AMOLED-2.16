...
constexpr RecentsScreenSnapshot::Data STYLESHEET_800_480_DARK_RECENTS_SCREEN_SNAPSHOT_DATA = {
    .main_size = gui::StyleSize::RECT(500, 352),
    .title = {
        .main_size = gui::StyleSize::RECT(500, 52),
    ...
    .image = {
        .main_size = gui::StyleSize::RECT(500, 300),
        .radius = 20,
    },
};

constexpr RecentsScreen::Data STYLESHEET_800_480_DARK_RECENTS_SCREEN_DATA = {
    .main = {
    ...
    .snapshot_table = {
        ...
        .snapshot = STYLESHEET_800_480_DARK_RECENTS_SCREEN_SNAPSHOT_DATA,
    },
    .trash_icon = {
