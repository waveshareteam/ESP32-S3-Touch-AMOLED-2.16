...
constexpr AppLauncherIcon::Data STYLESHEET_320_480_DARK_APP_LAUNCHER_ICON_DATA = {
    .main = {
...
constexpr AppLauncherData STYLESHEET_320_480_DARK_APP_LAUNCHER_DATA = {
    .main = {
        .y_start = 0,
        .size = gui::StyleSize::RECT_W_PERCENT(100, 444),
    },
    .table = {
        .default_num = 3,
