...
constexpr StatusBar::AreaData STYLESHEET_1280_800_DARK_STATUS_BAR_AREA_DATA(int w_percent, StatusBar::AreaAlign align)
{
    return {
...
constexpr StatusBar::Data STYLESHEET_1280_800_DARK_STATUS_BAR_DATA = {
    .main = {
    ...
    .area = {
        ...
        .data = {
            STYLESHEET_1280_800_DARK_STATUS_BAR_AREA_DATA(33, StatusBar::AreaAlign::START),
            STYLESHEET_1280_800_DARK_STATUS_BAR_AREA_DATA(34, StatusBar::AreaAlign::CENTER),
            STYLESHEET_1280_800_DARK_STATUS_BAR_AREA_DATA(33, StatusBar::AreaAlign::END),
        },
    },
