...
constexpr AppLauncherIcon::Data STYLESHEET_1024_600_DARK_APP_LAUNCHER_ICON_DATA = {
    .main = {
...
constexpr AppLauncherData STYLESHEET_1024_600_DARK_APP_LAUNCHER_DATA = {
    .main = {
        .y_start = 0,
    ...
    .table = {
        .default_num = 3,
        .size = gui::StyleSize::RECT_W_PERCENT(100, 495),
    },
    .indicator = {
        .main_size = gui::StyleSize::RECT_W_PERCENT(100, 35),
        .main_layout_column_pad = 10,
        .main_layout_bottom_offset = 20,
        .spot_inactive_size = gui::StyleSize::SQUARE(16),
        .spot_active_size = gui::StyleSize::RECT(40, 16),
        .spot_inactive_background_color = gui::StyleColor::COLOR(0xC6C6C6),
        .spot_active_background_color = gui::StyleColor::COLOR(0xFFFFFF),
    },
    .icon = STYLESHEET_1024_600_DARK_APP_LAUNCHER_ICON_DATA,
    .flags = {
