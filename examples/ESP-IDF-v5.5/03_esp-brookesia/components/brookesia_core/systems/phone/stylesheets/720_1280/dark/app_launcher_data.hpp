...
constexpr AppLauncherIcon::Data STYLESHEET_720_1280_DARK_APP_LAUNCHER_ICON_DATA = {
    .main = {
...
constexpr AppLauncherData STYLESHEET_720_1280_DARK_APP_LAUNCHER_DATA = {
    .main = {
        .y_start = 0,
    ...
    .icon = STYLESHEET_720_1280_DARK_APP_LAUNCHER_ICON_DATA,
    .flags = {
