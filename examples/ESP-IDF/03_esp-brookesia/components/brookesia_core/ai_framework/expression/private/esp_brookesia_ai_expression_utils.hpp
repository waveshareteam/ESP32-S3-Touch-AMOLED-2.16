...
#   error "Expression is not enabled, please enable it in the menuconfig"
#endif

#ifdef ESP_UTILS_LOG_TAG
#   undef ESP_UTILS_LOG_TAG
#endif
#define ESP_UTILS_LOG_TAG "BS:Expression"
#include "esp_lib_utils.h"

#if !ESP_BROOKESIA_EXPRESSION_ENABLE_DEBUG_LOG || defined(ESP_BROOKESIA_UTILS_DISABLE_DEBUG_LOG)
