...
constexpr base::Display::Data STYLESHEET_320_240_DARK_CORE_DISPLAY_DATA = {
    .background = {
        .color = gui::StyleColor::COLOR(0x1A1A1A),
        .wallpaper_image_resource = gui::StyleImage::IMAGE(&esp_brookesia_image_small_wallpaper_dark_240_240),
    },
    .text = {
...
constexpr base::Manager::Data STYLESHEET_320_240_DARK_CORE_MANAGER_DATA = {
    .app = {
        .max_running_num = 3,
    },
    .flags = {
...
constexpr const char *STYLESHEET_320_240_DARK_CORE_INFO_DATA_NAME = "320x240 Dark";
constexpr base::Context::Data STYLESHEET_320_240_DARK_CORE_DATA = {
    .name = STYLESHEET_320_240_DARK_CORE_INFO_DATA_NAME,
    .screen_size = gui::StyleSize::RECT(320, 240),
    .display = STYLESHEET_320_240_DARK_CORE_DISPLAY_DATA,
    .manager = STYLESHEET_320_240_DARK_CORE_MANAGER_DATA,
};
