...
constexpr base::Display::Data STYLESHEET_1024_600_DARK_CORE_DISPLAY_DATA = {
    .background = {
...
constexpr base::Manager::Data STYLESHEET_1024_600_DARK_CORE_MANAGER_DATA = {
    .app = {
        .max_running_num = 3,
    },
    .flags = {
...
constexpr const char *STYLESHEET_1024_600_DARK_CORE_INFO_DATA_NAME = "1024x600 Dark";

constexpr base::Context::Data STYLESHEET_1024_600_DARK_CORE_DATA = {
    .name = STYLESHEET_1024_600_DARK_CORE_INFO_DATA_NAME,
    .screen_size = gui::StyleSize::RECT(1024, 600),
    .display = STYLESHEET_1024_600_DARK_CORE_DISPLAY_DATA,
    .manager = STYLESHEET_1024_600_DARK_CORE_MANAGER_DATA,
};
